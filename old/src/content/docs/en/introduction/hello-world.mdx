...
While you can write all your programs like this and compile them with `rustc`, most Rust developers use Cargo, Rust's build system and package manager. Let's move on to [Hello, Cargo!](/en/introduction/hello-cargo/) to learn how to use it. 