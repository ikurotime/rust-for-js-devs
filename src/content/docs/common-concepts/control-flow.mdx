...
Now that you've learned about control flow in Rust, let's explore [Ownership](/ownership/what-is-ownership/), one of Rust's most distinctive features that doesn't exist in JavaScript. 