...
Now that you understand variables and mutability in Rust, let's move on to [Data Types](/common-concepts/data-types/) to learn about Rust's rich type system. 