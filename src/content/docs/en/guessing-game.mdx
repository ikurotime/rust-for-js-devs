...
Now that you've built a simple program and gained some familiarity with Rust, let's dive deeper into Rust's language features. Next, we'll cover [Common Programming Concepts](/common-concepts/variables-mutability/) in more detail, starting with variables and mutability. 