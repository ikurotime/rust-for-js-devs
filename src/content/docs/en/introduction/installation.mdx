...
Now that you've installed Rust and set up your development environment, let's write your first Rust program! Continue to [Hello World](/introduction/hello-world/) to see how to create and run a simple Rust program. 