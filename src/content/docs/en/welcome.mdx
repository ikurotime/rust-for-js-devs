...
1. **[Install Rust locally](/en/introduction/installation/)** (recommended for the full experience)
...
- [Introduction to Rust](/en/introduction/) - Learn why Rust is valuable for JS developers
- [Installation Guide](/en/introduction/installation/) - Set up your local Rust environment
- [Hello World](/en/introduction/hello-world/) - Write your first Rust program
- [Building a Guessing Game](/en/guessing-game/) - Create a complete application to get a feel for Rust
...
Now that you have an home of what you'll learn and how to get started, head to the [Introduction to Rust](/en/introduction/installation/) section to begin your journey. There you'll learn about what makes Rust special and how it compares to JavaScript. 