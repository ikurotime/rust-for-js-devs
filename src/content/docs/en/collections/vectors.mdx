...
Now that you understand how to work with vectors in Rust, let's explore another important collection type: [Strings](/collections/strings/). In the next section, we'll learn about Rust's string types and how they compare to JavaScript strings. 