...
Now that you've mastered the fundamentals of Rust's ownership system, including borrowing and lifetimes, you're ready to learn about structuring data in Rust. In the next section, we'll explore [Using Structs](/structs-enums/defining-structs/), which is Rust's way of creating custom data types. 