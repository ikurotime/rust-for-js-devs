...
Now that you understand the basics of Cargo, let's move on to [building a more substantial program](/guessing-game/) that will give you a better feel for Rust's syntax and features. 